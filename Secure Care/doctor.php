	...
	<div class="login-hny">
		<div class="form-content">
			...
			<div class="form-right">
				<div class="overlay">
					<div class="grid-info-form">
						...
						<p>Get the compassionate healing that you deserve.</p>
			...
			<div class="form-left">
				...
				<div class="middle">
					<h4>Search Doctor</h4>
					<p>Welcome! Please enter your place.</p>
				</div>
				<form action="doctor_view.php" method="post" class="signin-form" autocomplete="off">
