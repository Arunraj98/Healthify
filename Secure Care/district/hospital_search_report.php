                                ...
                                <div class="row">
                                   ...
                                   <div class="alert" style="padding:5px; background-color:#3399cc; color:white">
									...
									<div class="col-md-6 col-sm-6 col-xs-12">
                                     ...
                                     <div class="col-md-6 col-sm-6 col-xs-12">
                                            <label>Photo</label>
                                            <a href="../admin/hospital_photo/<?php echo $photo1;?>" target="_blank" class="btn btn-block btn-danger">Download</a>
                                    </div>	
                                     <div class="col-md-6 col-sm-6 col-xs-12">
                                            <label>Photo</label>
                                     ...
                                     <div class="col-md-6 col-sm-6 col-xs-12">
                                            <label>License</label>
                                           <a href="../admin/hospital_photo/<?php echo $photo3;?>" target="_blank" class="btn btn-block btn-danger">Download</a>
                                    </div>
                                    <div class="col-md-12 col-sm-12 col-xs-12">
                                       <label>Experience</label>
                                           <textarea  name="des"   class="form-control" rows="3" readonly><?php echo $exp;?></textarea>
                                     </div>                                                                                      
                                 </div>
