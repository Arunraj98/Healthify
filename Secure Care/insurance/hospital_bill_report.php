     ...
     <section class="invoice">
      ...
      <div class="row invoice-info">
        ...
        <div class="col-sm-3 invoice-col">
          <b>Hospital History Report </b><br>
        </div>
          <div class="col-sm-3 invoice-col">
      ...
      <div class="row">
        <div class="col-xs-12 table-responsive">
          ...
          <table class="table table-striped">
            ...
            <?php
				$tot=0;
				$result = $db->prepare("select * from  hospitalamount where mdcpatid= '$uniqueid'");
				$result->execute();
      ...
      <div class="row no-print">
        <div class="col-xs-12">
          ...
          <a type="button" class="btn btn-danger pull-right" style="margin-right: 5px; width:180px;" href="hospital_bill.php">
