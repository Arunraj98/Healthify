                ...
                <div class="box-body no-padding">
                	<div class="panel panel-primary">
  					  <div class="panel-heading ">
                            ...
                            <form method="post" action="database/prescription_save.php" enctype="multipart/form-data" autocomplete="off">
                                ...
                                <div class="row">
                                    	...
                                    	<div class="col-md-12 col-sm-12 col-xs-12">
                                         ...
                                         <div class="col-md-6 col-sm-12 col-xs-12">
                                          ...
                                          <div class="col-md-12 col-sm-12 col-xs-12">
                                           <label>Address</label>
                                          	<textarea  name="addr" rows="4"   class="form-control" value="<?php echo $addr; ?>" readonly><?php echo $addr; ?></textarea>
                                          </div>
                                          <div class="col-md-6 col-sm-12 col-xs-12">
                        	...
                        	<div class="col-md-6 col-sm-6 col-xs-12 well">
                                ...
                                <div class="row">
                                   ...
                                   <div class="alert" style="padding:5px; background-color:#3399cc; color:white">
                                    ...
                                    <div class="col-md-6 col-sm-6 col-xs-12">
                                      <label>Doctor</label>
                                      	<input type="text"  name="docname"   class="form-control" value="<?php echo $dname; ?>" readonly>
                                    </div>    
                                    <div class="col-md-6 col-sm-6 col-xs-12">
                                    ...
                                    <div class="col-md-12 col-sm-12 col-xs-12">
                                       <label>Diseases Description</label>
                                           <textarea  name="diseasdesc"   class="form-control" rows="5" required></textarea>
                                     </div> 
                                      <div class="col-md-12 col-sm-12 col-xs-12">
                                       <label>Prescription</label>
                                           <textarea  name="prescriptn"   class="form-control" rows="5" required></textarea>
                                     </div> 
                                      <div class="col-md-12 col-sm-12 col-xs-12">
                                       <label>Lab Test Description</label>
                                           <textarea  name="lbtestdescp"   class="form-control" rows="5" required></textarea>
                                     </div>                                    
                                 </div>
                            ...
                            <div class="col-md-3 col-sm-6 col-xs-12 well" style="float:right">
                            	 ...
                            	 <div class="col-md-6 col-sm-6 col-xs-12">
                                 	<a href="prescription_search.php" class="btn btn-block btn-danger">Back</a>
                            	 </div>
