              ...
              <h3 class="box-title">Booking Pending</h3>
         	  ...
         	  <div class="box-body no-padding">
				 <div class="box-body">
                  ...
                  <tbody>	
                  	<?php
					$bkid=$_SESSION['SESS_DOC_ID'];
					$result = $db->prepare("select * from  booking where bkid='$bkid' and stat='pending'");
					$result->execute();
					for($i=1; $row = $result->fetch(); $i++)
						...
						?>
                        	<td>
	                        	<a href="booking_pending_report.php<?php echo '?hbkid='.$hbkid; ?>" style="float:right" class="btn btn-block btn-google">Pending</a>
							</td>                                
                        <?php															
						echo"</tr>";
						}
