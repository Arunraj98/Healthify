                ...
                <div class="box-body no-padding">
                	<div class="panel panel-primary">
  					  <div class="panel-heading ">
                            ...
                            <form method="post" action="database/hospital_save.php" enctype="multipart/form-data" autocomplete="off">
                            <div class="col-md-6 col-sm-6 col-xs-12 well">
                                ...
                                <div class="row">
                                    	...
                                    	<div class="col-md-12 col-sm-12 col-xs-12">
                                            ...
                                            <input type="text" class="form-control" name="hostid"  required="" value="<?php echo"MDCHP".rand(98745896,1); ?>" readonly>
                                        </div>                                                                                
                                          <div class="col-md-6 col-sm-12 col-xs-12">
                                           <label>Name</label>
                                           <input type="text"  name="hname"   class="form-control" required title="CAPS ONLY" pattern="[a-zA-Z]*">
                                          </div>                                                                                    
                                          <div class="col-md-6 col-sm-12 col-xs-12">
                                          ...
                                          <div class="col-md-6 col-sm-12 col-xs-12">
                                           ...
                                           <input type="text"  name="location"   class="form-control" required  pattern="[a-zA-Z]*">
                                          </div>
                                          <div class="col-md-12 col-sm-12 col-xs-12">
                                           <label>Address</label>
                                          ...
                                          <div class="col-md-6 col-sm-12 col-xs-12">
                                           <label>Web Address</label>
                                          	<input type="url"  name="waddr"   class="form-control" required >
                                          </div>
                                         <div class="col-md-6 col-sm-6 col-xs-12">
                                          ...
                                          <div class="col-md-6 col-sm-6 col-xs-12">
                                            ...
                                            <input type="text"  name="special"  class="form-control" required pattern="[a-zA-Z]*">
                                          </div> 
                                          <div class="col-md-6 col-sm-6 col-xs-12">
                                   ...
                                   <div class="alert" style="padding:5px; background-color:#3399cc; color:white">
                                    ...
                                    <div class="col-md-6 col-sm-12 col-xs-12">
                                       <label>Speciality</label>
                                            <select class="form-control"  name="seplty" required >
                                     ...
                                     <div class="col-md-6 col-sm-12 col-xs-12">
                                       <label>Type</label>
                                            <select class="form-control"  name="typ" required>
                                                <option value="">Select</option>
                                                <option>General Medical and Surgical Hospital</option>
                                                <option>Speciality Hospital</option>
                                                <option>Clinics</option>
                                                <option>Psychiatric Hospital</option>
                                                <option>Emergency and Other Outpatient Care Centers </option>
                                    ...
                                    <div class="col-md-12 col-sm-12 col-xs-12">
                                       <label>Experience</label>
                                           <textarea  name="exp"   class="form-control" rows="6" required></textarea>
                                     </div> 
                                     <div class="col-md-6 col-sm-6 col-xs-12">
