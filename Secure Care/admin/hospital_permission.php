                ...
                <tbody>		
					...
					for($i=1; $row = $result->fetch(); $i++)
						...
						echo"<tr>";						
						  ...
						  ?>
						  <td>
							<a href="database/hospital_permission_inactive.php<?php echo '?hostid='.$hostid; ?>" class=" btn btn-sm btn-danger">&nbsp;Block</a>
						 </td>                                                                     
                         <?php
							}
							else
						 ...
						 ?>
                          <td>
							<a href="database/hospital_permission_active.php<?php echo '?hostid='.$hostid; ?>" class=" btn btn-sm btn-success">&nbsp;Allow</a>
						 </td>  
						<?php		
							}
						echo"</tr>";
