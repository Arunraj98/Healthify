    	...
    	<!-- USERS LIST -->
   		<div class="box box-danger">
              ...
              <ul class="users-list clearfix">
               <?php
				...
				for($i=1; $row = $result->fetch(); $i++)
					...
					?>
                <li>
                  <img src="hospital_photo/<?php echo $row["photo1"];?>" alt="User Image">
            ...
            <div class="box-footer text-center">
              <a href="hospital_search.php" class="uppercase">View All Hospitals</a>
            </div>
        <!-- /.box-footer -->
        </div>
    	<!--/.box -->
   		...
   		<div class="box box-danger">
            ...
            <div class="box-body no-padding">
			 ...
			 <?php
                ...
                ?>
                <li>
                  <img src="doctor_photo/<?php echo $row["photo1"];?>" alt="User Image">
            ...
            <!-- /.box-body -->
            <div class="box-footer text-center">
              <a href="district_search.php" class="uppercase">View All Doctors</a>
            </div>
        <!-- /.box-footer -->
        </div>
    	<!--/.box -->
