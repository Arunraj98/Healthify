                ...
                <div class="box-body no-padding">
                	<div class="panel panel-primary">
  					  <div class="panel-heading ">
                            ...
                            <form method="post" action="database/laboratory_update.php" enctype="multipart/form-data" autocomplete="off">
                            ...
                            <div class="col-md-3 col-sm-6 col-xs-12 well" style="float:right">
                                 ...
                                 <input type="submit" value="Update" class="btn btn-block btn-primary" id="save1">
                            	  ...
                            	  <div class="col-md-6 col-sm-6 col-xs-12 pull-right">
                                 	<a href="laboratory_edit.php" class="btn btn-block btn-danger">Back</a>
                            	 </div>  
