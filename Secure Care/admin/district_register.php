                            ...
                            <div class="col-md-6 col-sm-6 col-xs-12 well">
                                ...
                                <div class="row">
                                    	...
                                    	<div class="col-md-12 col-sm-12 col-xs-12">
                                            ...
                                            <input type="text" class="form-control" name="mdcdcid"  required="" value="<?php echo"MDCDST".rand(9874475896,1); ?>" readonly>
                                        </div>                                                                                
                                          ...
                                          <div class="col-md-6 col-sm-12 col-xs-12">
                                           ...
                                           <input type="text"  name="inchaprsn"   class="form-control" required>
                                          </div>                                                                                    
                                          <div class="col-md-6 col-sm-12 col-xs-12">
