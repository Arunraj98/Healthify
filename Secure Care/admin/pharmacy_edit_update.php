                ...
                <div class="box-body no-padding">
                	<div class="panel panel-primary">
  					  <div class="panel-heading ">
                            ...
                            <form method="post" action="database/pharmacy_update.php" enctype="multipart/form-data" autocomplete="off">
                                ...
                                <div class="row">
                                   ...
                                   <div class="alert" style="padding:5px; background-color:#3399cc; color:white">
									...
									<div class="col-md-6 col-sm-6 col-xs-12">
                                     ...
                                     <div class="col-md-6 col-sm-6 col-xs-12">
                                            <label>Photo</label>
                                            <a href="pharmacy_photo/<?php echo $photo1;?>" target="_blank" class="btn btn-block btn-danger">Download</a>
                                    </div>	
                                      <div class="col-md-6 col-sm-6 col-xs-12">
                                     ...
                                     <div class="col-md-6 col-sm-6 col-xs-12">
                                            <label>License</label>
                                            <a href="pharmacy_photo/<?php echo $photo2;?>" target="_blank" class="btn btn-block btn-danger">Download</a>
                                    </div>
                                    <div class="col-md-12 col-sm-12 col-xs-12">
                            ...
                            <div class="col-md-3 col-sm-6 col-xs-12 well" style="float:right">
                                 ...
                                 <input type="submit" value="Update" class="btn btn-block btn-primary" id="save1">
                            	  ...
                            	  <div class="col-md-6 col-sm-6 col-xs-12 pull-right">
                                 	<a href="pharmacy_edit.php" class="btn btn-block btn-danger">Back</a>
                            	 </div>  
