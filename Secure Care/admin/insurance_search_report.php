<?php
    ...
    $inscname=$_POST["inscname"];
	$result = $db->prepare("select * from  insurance where name='$inscname'");
	$result->execute();
                ...
                <div class="box-body no-padding">
                	<div class="panel panel-primary">
  					  <div class="panel-heading ">
							Insurance Company Informations
                        </div>
							<div class="panel-body">  
                            
                            <form method="post" action="database/insurance_save.php" enctype="multipart/form-data" autocomplete="off">
                            ...
                            <div class="col-md-3 col-sm-6 col-xs-12 well" style="float:right">                                                           
                                  <div class="col-md-6 col-sm-6 col-xs-12 pull-right">
                                 	<a href="insurance_search.php" class="btn btn-block btn-danger">Back</a>
                            	 </div>                                                           	
                            </div>
