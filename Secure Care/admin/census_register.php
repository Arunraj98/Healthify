                ...
                <div class="box-body no-padding">
                	<div class="panel panel-primary">
  					  <div class="panel-heading ">
							Add New Census Authority
                        </div>
							<div class="panel-body">  
                            
                            <form method="post" action="database/census_save.php" enctype="multipart/form-data" autocomplete="off">
                            <div class="col-md-6 col-sm-6 col-xs-12 well">
                                ...
                                <div class="row">
                                    	...
                                    	<div class="col-md-12 col-sm-12 col-xs-12">
                                            ...
                                            <input type="text" class="form-control" name="censuspid"  required="" value="<?php echo"CENSUSID".rand(9874475896,1); ?>" readonly>
                                        </div>                                                                                
                                          ...
                                          <div class="col-md-6 col-sm-12 col-xs-12">
                                           ...
                                           <input type="text"  name="inchaprsn"   class="form-control" required  pattern="[a-zA-Z]*">
                                          </div>                                                                                    
                                          <div class="col-md-6 col-sm-12 col-xs-12">
                                ...
                                <div class="row">
                                   ...
                                   <div class="alert" style="padding:5px; background-color:#3399cc; color:white">
									  ...
									  <div class="col-md-6 col-sm-6 col-xs-12">
										...
										<input type="url"  name="wbaddr"  class="form-control" required>
									</div>	  
                                     <div class="col-md-6 col-sm-6 col-xs-12">
