                ...
                <div class="box-body no-padding">
                	<div class="panel panel-primary">
  					  <div class="panel-heading ">
							Panchayath Informations Update
                        </div>
							<div class="panel-body">  
                            
                            <form method="post" action="database/panchayath_update.php" enctype="multipart/form-data" autocomplete="off">
