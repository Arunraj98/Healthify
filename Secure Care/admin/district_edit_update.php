                ...
                <div class="box-body no-padding">
                	<div class="panel panel-primary">
  					  <div class="panel-heading ">
							District Informations Update
                        </div>
							<div class="panel-body">  
                            
                            <form method="post" action="database/district_update.php" enctype="multipart/form-data" autocomplete="off">
                            <div class="col-md-6 col-sm-6 col-xs-12 well">
                                ...
                                <div class="row">
                                    	...
                                    	<div class="col-md-12 col-sm-12 col-xs-12">
                                            ...
                                            <input type="text" class="form-control" name="mdcdcid" value="<?php echo $mdcdcid ?>" readonly>
                                        </div>                                                                                
                                          ...
                                          <div class="col-md-6 col-sm-12 col-xs-12">
                                           <label>Contact No</label>
                                           <input type="number"  name="cntn2"   class="form-control" value="<?php echo $cntn2 ?>" requierd>
                                          </div>                                                                                                                   
                                         <div class="col-md-12 col-sm-12 col-xs-12">
                                            <label>Email ID</label>
                                            <input type="email"  name="email"  class="form-control" value="<?php echo $email ?>" requierd>
                                         </div>                                                                                                                                     				
                                    </div>
                        	...
                        	<div class="col-md-6 col-sm-6 col-xs-12 well">
                                ...
                                <div class="row">
                                   ...
                                   <div class="alert" style="padding:5px; background-color:#3399cc; color:white">
                                   	 ...
                                   	 <div class="col-md-12 col-sm-12 col-xs-12">
                                       <label>Address</label>
                                      	<textarea  name="addr" rows="4"   class="form-control" requierd><?php echo $addr ?></textarea>
                                      </div>                                       				
                                     ...
                                     <div class="col-md-6 col-sm-6 col-xs-12">
										...
										<input type="text"  name="jdate"  class="form-control" value="<?php echo $jdate ?>" readonly requierd>
									</div>	                                                                                                  
                                     <div class="col-md-6 col-sm-6 col-xs-12">
                            ...
                            <div class="col-md-3 col-sm-6 col-xs-12 well" style="float:right">                            
                                 ...
                                 <input type="submit" value="Update" class="btn btn-block btn-primary" id="save1">
                                  ...
                                  <div class="col-md-6 col-sm-6 col-xs-12 pull-right">
                                 	<a href="district_edit.php" class="btn btn-block btn-danger">Back</a>
                            	 </div>                                                           	
                            </div>
