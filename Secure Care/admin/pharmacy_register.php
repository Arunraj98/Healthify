                            ...
                            <div class="col-md-6 col-sm-6 col-xs-12 well">
                                ...
                                <div class="row">
                                    	...
                                    	<div class="col-md-12 col-sm-12 col-xs-12">
                                            ...
                                            <input type="text" class="form-control" name="mdcphid"  required="" value="<?php echo"MDCPH".rand(9874005896,1); ?>" readonly>
                                        </div>                                                                                
                                          ...
                                          <div class="col-md-6 col-sm-12 col-xs-12">
                                           ...
                                           <input type="text"  name="locatn"   class="form-control" required  pattern="[a-zA-Z]*">
                                          </div>
                                          <div class="col-md-12 col-sm-12 col-xs-12">
                                           <label>Address</label>
