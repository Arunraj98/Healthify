<?php
    ...
    $panchname=$_POST["panchname"];
	$result = $db->prepare("select * from  panchayath where name='$panchname'");
	$result->execute();
	for($i=0; $row = $result->fetch(); $i++)
	{
		$mdcpanid=$row["mdcpanid"];
		$name=$row["name"];
  					  ...
  					  <div class="panel-heading ">
                            ...
                            <div class="col-md-6 col-sm-6 col-xs-12 well">
                                ...
                                <div class="row">
                                    	...
                                    	<div class="col-md-12 col-sm-12 col-xs-12">
                                            ...
                                            <input type="text" class="form-control" name="mdcpanid" value="<?php echo $mdcpanid ?>" readonly>
                                        </div>                                                                                
                            ...
                            <div class="col-md-3 col-sm-6 col-xs-12 well" style="float:right">                                                           
                                  <div class="col-md-6 col-sm-6 col-xs-12 pull-right">
                                 	<a href="panchayath_search.php" class="btn btn-block btn-danger">Back</a>
                            	 </div>                                                           	
                            </div>
