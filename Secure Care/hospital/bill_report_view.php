      ...
      <div class="row">
        <div class="col-xs-12">
          <h2 class="page-header">
            ...
            <i class="fa fa-globe"></i> SECURE CARE HOSPITAL :  <?php echo strtoupper($dname);?>
      ...
      <div class="row">
        <div class="col-xs-12 table-responsive">
          ...
          <table class="table table-striped">
            ...
            <?php
				$tot=0;
				$result = $db->prepare("select * from  hospitalamount where date>= '$fdate' and date<= '$tdate' and hospital='$dname' order by date asc");
				$result->execute();
