...
<section class="w3l-blog-grids-6">
		...
		<div class="grids-layout">
			<div class="wrapper">
				...
				<div class="grid grid-column-2">
					<?php
					$result = $db->prepare("select * from hospital where special like'%".$diseases."%' and stat='active'");
					$result->execute();
        ...
        <div class="grids-layout">
			<div class="wrapper">
            	<h3 class="hny-title text-center"><span class="sub-title">What They Say?</span>Our Doctors</h3>
				<div class="grid grid-column-2">
					<?php
					$result = $db->prepare("select * from doctor where special like'%".$diseases."%' and stat='active'");
					$result->execute();
					for($i=0; $row = $result->fetch(); $i++)
					{
					?>
                    <div class="column">
						<div class="gd-innf">
							<a href="login.php"><img class="img-responsive" src="admin/doctor_photo/<?php echo $row["photo1"];?>" alt="hny"></a>
							<ul class="admin-list">
								<li><a href="login.php"><span class="fa fa-user" aria-hidden="true"></span><?php echo $row["name"];?></a></li>
								<li><a href="login.php"><span class="fa fa-user" aria-hidden="true"></span><?php echo $row["qul"];?></a></li>
                                <li><a href="login.php"><span class="fa fa-user" aria-hidden="true"></span><?php echo $row["special"];?></a></li>
							</ul>
	
							<h4> <a href="login.php" class="vv-link"><?php echo $row["qul"];?></a></h4>
