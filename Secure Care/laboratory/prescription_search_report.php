                                   ...
                                   <div class="alert" style="padding:5px; background-color:#3399cc; color:white">
                                    ...
                                    <div class="col-md-12 col-sm-12 col-xs-12">
                                       <label>Diseases Description</label>
                                           <textarea  name="diseasdesc"   class="form-control" rows="2" readonly><?php echo $diseasdesc; ?></textarea>
                                     </div> 
                                      <div class="col-md-12 col-sm-12 col-xs-12">
                                       <label>Prescription</label>
                                           <textarea  name="prescriptn"   class="form-control" rows="3" readonly><?php echo $prescriptn; ?></textarea>
                                     </div>  
                                      <div class="col-md-6 col-sm-6 col-xs-12">
                                        <label>Result</label>
                                     ...
                                     <div class="col-md-12 col-sm-12 col-xs-12">
                                       ...
                                       <input type="text"  name="lab"   class="form-control" value="<?php echo $dname;?>" readonly>
                                     </div>	                                                                    
                                 </div>
