     ...
     <section class="invoice">
      ...
      <div class="row">
        <div class="col-xs-12 table-responsive">
          ...
          <table class="table table-striped">
            ...
            <?php
				$tot=0;
				$result = $db->prepare("select * from  doctoramount where mdcpatid= '$uniqueid'");
				$result->execute();
      ...
      <div class="row no-print">
        <div class="col-xs-12">
          ...
          <a type="button" class="btn btn-danger pull-right" style="margin-right: 5px; width:180px;" href="doctor_bill.php">
